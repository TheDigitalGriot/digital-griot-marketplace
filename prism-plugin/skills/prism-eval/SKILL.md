...
> See also: [griot-agent-architect/references/token-optimization-research.md](../griot-agent-architect/references/token-optimization-research.md) §10 (Plugin Audit Checklist) for token-budget and quality-gate patterns applicable when designing new eval dimensions.
